...
import { TablaSolicitudesRefacciones} from "../../components/tabla-solicitudes-refacciones/TablaSolicitudesRefacciones";
...
import "./ListaSolicitudesRefaccionesPage.styles.scss";
...
export const ListaSolicitudesRefaccionesPage  = () => {
  ...
  useEffect(() => {
    fetchUnidades(`https://ec2-3-20-255-18.us-east-2.compute.amazonaws.com/api/core/partsrequests/`);
  }, [authtoken]);
  ...
  const changePage = (num) => {
    ...
    fetchUnidades(
      `https://ec2-3-20-255-18.us-east-2.compute.amazonaws.com/api/core/partsrequests/?page=${newCurrentPage}`
    );
  ...
  return (
    <Container style={{ maxWidth: "100%", maxHeight: "100%" }}>
      <Row className="text-center mb-3">
        <h3 className="m-0">Lista de Solicitudes de Refacciones</h3>
      </Row>
    ...
    <div class="contenedor-circulo">
      ...
      {isLoading ? (
        ...
        <Row>
          ...
          <TablaSolicitudesRefacciones solicitudes={solicitudes} setSolicitudes={setSolicitudes} />
