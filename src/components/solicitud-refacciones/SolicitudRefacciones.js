...
export const SolicitudRefacciones = ({ ordenTrabajoData }) => {
...
//   }, []);
  ...
  const getPartes = async (e, parteRef) => {
    ...
    const url = `https://ec2-3-20-255-18.us-east-2.compute.amazonaws.com/api/core/parts/?sae_key=${e.target.value}`;
        ...
        <div className="cotizacion-container">
          ...
          <form onSubmit={handleSumbit}>
            ...
            <div className="text-center m-3">
              ...
              <h1>Solicitud de Refacciones</h1>
            </div>
