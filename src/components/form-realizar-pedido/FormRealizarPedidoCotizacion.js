...
export const FormRealizarPedidoCotizacion = ({ pedidoData, linea, condicionVentaId, cotizacionId }) => {

  console.log(linea.producto_detail.diseño);
  ...
  useEffect(() => {
    ...
    if (pedidoData) {
      ...
      setForm({
        ...
        forma_carga: pedidoData.forma_carga,
      });
      ...
      } else if (pedidoData.forma === "BC") {
        document.querySelector("#tipoBomba").disabled = true;
        document.querySelector("#numeroBomba").disabled = true;
        document.querySelector("#metros_adicionales").disabled = true;
        document.querySelector("#proveedor_bomba").disabled = true;
        document.querySelector("#forma_carga").disabled = true;
  ...
  const handleChange = (e) => {
    ...
    if (e.target.name === "forma") {
      if (e.target.value === "T" ) {
        ...
        formaCargaRef.current.disabled = false;
      } else if (e.target.value === "BC") {
        setForm({
          ...form,
          forma: formaRef.current.value,
          tipo_bomba: "",
        ...
        metrosAdicionalesRef.current.disabled = true;
        proveedorBombaRef.current.disabled = true;
        formaCargaRef.current.disabled = true;
  ...
  const handleSubmit = async (e, historyRef) => {
    ...
    formData.append("condicion_venta", condicionVentaId);
    formData.append("cotizacion", cotizacionId);
    ...
    formData.append("forma_carga ", form.forma_carga );
      ...
      <div className="row justify-content-center">
        <div className="col-12 col-sm-8">
          {pedidoData ? (
            ...
            <h3 className="text-center">Agregar Pedidosss</h3>
          )}
          <form
          ...
          >
            ...
            <div className="mb-2">
              <label htmlFor="forma_carga" className="form-label">
                Forma de carga
              </label>
              <select
                name="forma_carga"
                id="forma_carga"
                onChange={handleChange}
                value={form.forma_carga}
                className="form-select"
                required
                ref={formaCargaRef}
              >
                <option value=""></option>
                <option value="A botones">A botones</option>
                <option value="A carrteillas">A carrteillas</option>
                <option value="Directo">Directo</option>
                <option value="Paleado">Paleado</option>
              </select>
            </div>
            ...
            <div className="mb-2">
              ...
              >
                ...
                <option value="Martin picon">Martin picon</option>
                <option value="Lancreto">Lancreto</option>
                <option value="Luis Carlos Mendoza">Luis Carlos Mendoza</option>
                <option value="EUTO">EUTO</option>
              </select>
            </div>
