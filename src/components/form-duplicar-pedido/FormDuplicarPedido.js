...
import "./FormDuplicarPedido.styles.scss";
...
export const FormDuplicarPedido = ({ pedidoData }) => {
  ...
  useEffect(() => {
    ...
    if (pedidoData) {
      ...
      setForm({
        ...
        obra: pedidoData.obra_id,
        condicion_venta: pedidoData.condicion_venta,
        cotizacion: pedidoData.cotizacion,
  ...
  const handleSubmit = async (e, historyRef) => {
    ...
    formData.append("obra", form.obra);
    ...
    formData.append("condicion_venta", form.condicion_venta);
    formData.append("cotizacion", form.cotizacion);
    ...
    //     `	https://ec2-3-18-209-167.us-east-2.compute.amazonaws.com/api/pedidos/${pedidoData.id}/update/`,
    //     {
    //       method: "PATCH",
    //       headers: {
    ...
    // } else {
      ...
      let data = await fetch(
        "	https://ec2-3-18-209-167.us-east-2.compute.amazonaws.com/api/pedidos/create/",
        {
          method: "POST",
          headers: {
            Authorization: `Token ${authtoken}`,
